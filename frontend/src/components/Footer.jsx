      ...
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
        ...
        <div className="backdrop-blur-lg bg-white/10 p-6 rounded-xl shadow-md border border-gray-900">
          ...
          <ul className="mt-2 space-y-2">
            <li><a href="/dashboard" className="hover:text-purple-400 transition-all duration-300" >Home</a></li>
            <li><a href="/sells" className="hover:text-purple-400 transition-all duration-300">Sells</a></li>
            <li><a href="rents" className="hover:text-purple-400 transition-all duration-300">Rents</a></li>
            <li><a href="contact" className="hover:text-purple-400 transition-all duration-300">Contact Us</a></li>
          </ul>
        </div>
        ...
        <div className="backdrop-blur-lg bg-white/10 p-6 rounded-xl shadow-md border border-gray-900">
          ...
          <div className="flex space-x-4 mt-3">
            ...
            <a href="https://www.instagram.com/abhi9.acb/" target="_blank" className="text-gray-300 hover:text-purple-400 transition-all duration-300"><FaInstagram size={24} /></a>
