    ...
    <div className="flex items-center justify-between p-2 bg-gray-900 text-white shadow-lg border-b border-gray-700">
      ...
      {/* Sidebar */}
        ...
        <ul className="mt-6 space-y-6 text-lg font-semibold">
         ...
         {
          displayUser.role==="student"&&  <li className="hover:text-blue-400 cursor-pointer transition-transform transform hover:scale-110" onClick={() => navigate('/chat')}>📩 Chats</li>
         }
         ...
         (
             <ul className="mt-2 space-y-2 text-lg font-semibold">
              <li className="px-4  hover:bg-red-600 cursor-pointer" onClick={() => navigate('/admin-dashboard')}>      dashboard
                ...
                <li className="px-4  hover:bg-red-600 cursor-pointer" onClick={() => navigate('/contact=received')}>
                   contacts received
                </li>
