  ...
  return (
    <div className="flex items-center justify-between p-2 bg-gray-900 text-white shadow-lg border-b border-gray-700">
          ...
          {isProfileOpen && (
            <div className="absolute z-20 right-0 mt-2 w-48 bg-gray-800 text-white rounded-lg shadow-lg overflow-hidden profile-menu">
              <ul className="py-2">
                ...
                <li className="px-4 py-2 hover:bg-gray-700 cursor-pointer" onClick={() => navigate('/editProfile')}>
                  ✏️ Edit Profile
                </li>
      ...
      >
        ⚙️ Settings
        {isSettingsOpen && (
          <ul className="absolute left-0  w-48 bg-gray-800 text-white rounded-lg shadow-lg overflow-hidden">
            <li
