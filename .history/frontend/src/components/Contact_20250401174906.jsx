    ...
    const fetchUser = async () => {
      try {
        ...
        if (response.ok) {
          ...
          setStatus({ submitted: false, error: "User not authenticated" });
        }
      } catch (error) {
        setStatus({ submitted: false, error: "Failed to fetch user details" });
      }
    };
        ...
        {status.submitted ? (
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <p className="text-gray-300"><strong>Name:</strong> {user.name || "Loading..."}</p>
              <p className="text-gray-300"><strong>Email:</strong> {user.email || "Loading..."}</p>
