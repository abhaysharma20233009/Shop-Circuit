  ...
  const handleUpload = async (e) => {
    ...
    try {
      const res = await axios.post(
        "http://localhost:3000/api/v1/users/upload-profile-photo", // Your API endpoint
        formData,
        {
          headers: {
            "Content-Type": "multipart/form-data", // Required for file uploads
          },
          withCredentials: true, // Ensures cookies/sessions are sent if needed
        }
      );
      ...
      // Update profile picture in state (if API returns the new URL)
