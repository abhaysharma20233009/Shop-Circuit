...
exports.getAllProducts = catchAsync(async (req, res, next) => {
  let filter = { status: "pending" }; // Only fetch products with status 'pending'
  ...
  // Filter only products from shopkeepers
  const productsWithSellers = products
    .filter(product => product.sellerId?.sellerType === "shopkeeper") 
